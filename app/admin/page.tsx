...
export default function Dream9Page() {
  ...
  const [designTitle, setDesignTitle] = useState("Dream 9");
  const [titleFontSize, setTitleFontSize] = useState(68);
  const [titleTopPadding, setTitleTopPadding] = useState(0);
  const [shirtMode, setShirtMode] = useState<"light" | "dark">("light");
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    borderColor: shirtMode === "dark" ? "white" : "black",
                  }}
    ...
    return (
      ...
      >
        <div className="flex h-full flex-col">
          ...
          <div
            className="mx-auto grid w-[95%] grid-cols-3 gap-x-[3%] gap-y-[5px] pt-[2.5%] font-black leading-[1.25]"
            style={{
              color: inkColor,
            }}
          >
  ...
  return (
    <main className="min-h-screen overflow-x-hidden bg-black px-4 py-5 text-white md:p-6">
      <div className="mx-auto grid w-full max-w-7xl gap-0 lg:grid-cols-[420px_1fr] lg:gap-8">
        ...
        <div className="mx-auto mb-4 grid w-full max-w-[540px] gap-3 border border-white/10 bg-white/[0.04] p-4">
          <input
            value={designTitle}
            onChange={(e) => setDesignTitle(e.target.value)}
            placeholder="Title"
            className="bg-white/10 px-4 py-3 text-white outline-none"
          />
          ...
          <input
            ...
            onChange={(e) => setTitleTopPadding(Number(e.target.value))}
          />

          <div className="grid grid-cols-2 gap-2">
            <button
              onClick={() => setShirtMode("light")}
